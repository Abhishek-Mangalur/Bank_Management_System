...
from app.models import Account, Transaction, Loan, LoanTransaction, FixedDeposit
from app.forms import AccountForm, EmailForm, EditForm, AccountNumberForm, DepositeForm, UpdateAmountForm, NumberForm, PinForm, AtmDepositForm, LoanSelectForm, PayLoanForm, LoanForm, FixedDepositForm
